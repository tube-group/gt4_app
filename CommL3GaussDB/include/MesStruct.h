...
struct GSP819
{
    inline static const FieldList fields = {
        ...
        make_field("HOT_TREAT_METHOD_CODE", "热处理方式", 'C', 1, 0),
        make_field("HOT_TREAT_METHOD", "热处理方式", 'C', 40, 0),
        make_field("ORIGIN_CODE", "来源代码", 'C', 4, 0),
        make_field("PROD_CODE", "品名细分类代码", 'C', 2, 0),
        make_field("PROD_CNAME", "品名细分类中文", 'C', 30, 0),
        make_field("ORDER_LEN_MIN", "订货长度下限", 'D', 12, 3),
        make_field("ORDER_LEN_MAX", "订货长度上限", 'D', 12, 3),
...
struct GSP813
{
    inline static const FieldList fields = {
        ...
        make_field("THREAD_TYPE_CODE", "螺纹类型代码", 'C', 1, 0),
        make_field("THREAD_TYPE_SIGN", "螺纹类型符号", 'C', 12, 0),
        make_field("HEAT_TREAT_STATUS_CODE", "热处理方式代码", 'C', 1, 0),
        ...
        make_field("TOTAL_LEN", "总长度", 'D', 9, 3),
        make_field("STOCK_PLACE_NO", "库位号", 'C', 15, 0),
        make_field("MAT_NO_OLD", "原材料号", 'C', 20, 0),
        make_field("TUBE_NO", "管号", 'C', 7, 0),
        make_field("TUBE_ACT_WT", "单根管子重量", 'D', 15, 6),
        make_field("TUBE_LEN", "单根管子长度", 'I', 9, 0),
    };
};
...
{
    inline static const FieldList fields = {
        make_field("BREAKDN_DATE", "故障日期", 'C', 8, 0),
        make_field("DEV_CODE", "设备代码", 'C', 6, 0),
        make_field("DEV_NAME", "设备名称", 'C', 40, 0),
        make_field("WORK_LINE_CODE", "作业线代码", 'C', 7, 0),
        make_field("WORK_LINE_NAME", "作业线名称", 'C', 50, 0),
        make_field("ACC_START_TIME", "故障开始时间", 'C', 14, 0),
        make_field("ACC_END_TIME", "故障结束时间", 'C', 14, 0),
        make_field("TOTAL_BREAKDN_TIME", "故障时间合计", 'D', 6, 2),
        make_field("BREAKDN_TYPE_CODE", "故障类别代码", 'C', 2, 0),
        make_field("BREAKDN_TYPE_TEXT", "故障类别正文", 'C', 50, 0),
        make_field("BREAKDN_START_GRP", "故障开始班别", 'C', 1, 0),
        make_field("REMARK", "备注", 'C', 80, 0),
    };
};
