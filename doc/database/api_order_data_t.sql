...
COMMENT ON COLUMN api_order_data_t.thread_type_code IS '螺纹类型代码';
COMMENT ON COLUMN api_order_data_t.thread_type_sign IS '螺纹类型符号';
COMMENT ON COLUMN api_order_data_t.end_type_code IS '管端类型代码';
COMMENT ON COLUMN api_order_data_t.end_type_sign IS '管端类型符号';
...
COMMENT ON COLUMN api_order_data_t.qual_special_req IS '质量特殊要求';
COMMENT ON COLUMN api_order_data_t.produce_special_req IS '生产特殊要求';
...
COMMENT ON COLUMN api_order_data_t.last_flow_no IS '最后流水号';
...
COMMENT ON COLUMN api_order_data_t.toc IS '修改时间';
...
COMMENT ON COLUMN api_order_data_t.end_type IS '管端类型';
COMMENT ON COLUMN api_order_data_t.coupling_type IS '接箍类型';
COMMENT ON COLUMN api_order_data_t.mic_no IS 'MIC编号';
COMMENT ON COLUMN api_order_data_t.diameter_down_ctrl IS '外径下限_内控';
COMMENT ON COLUMN api_order_data_t.diameter_up_ctrl IS '外径上限_内控';
COMMENT ON COLUMN api_order_data_t.wal_thick_down_ctrl IS '壁厚下限_内控';
COMMENT ON COLUMN api_order_data_t.wal_thick_up_ctrl IS '壁厚上限_内控';
COMMENT ON COLUMN api_order_data_t.height_down_ctrl IS '高度下限_内控';
COMMENT ON COLUMN api_order_data_t.height_up_ctrl IS '高度上限_内控';
COMMENT ON COLUMN api_order_data_t.length_grade_code IS '长度等级编码';
COMMENT ON COLUMN api_order_data_t.length_grade IS '长度等级';
COMMENT ON COLUMN api_order_data_t.thread_type IS '螺纹类型';
COMMENT ON COLUMN api_order_data_t.stamp_req_1_manual IS '针刻印要求1';
COMMENT ON COLUMN api_order_data_t.stamp_req_2_manual IS '针刻印要求2';
COMMENT ON COLUMN api_order_data_t.stamp_req_3_manual IS '针刻印要求3';
COMMENT ON COLUMN api_order_data_t.stamp_req_4_manual IS '针刻印要求4';
COMMENT ON COLUMN api_order_data_t.stamp_req_5_manual IS '针刻印要求5';
COMMENT ON COLUMN api_order_data_t.stamp_req_6_manual IS '针刻印要求6';
COMMENT ON COLUMN api_order_data_t.stamp_req_7_manual IS '针刻印要求7';
COMMENT ON COLUMN api_order_data_t.stamp_req_8_manual IS '针刻印要求8';