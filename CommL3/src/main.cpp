...
void ConnectToGauss() {
    try {
        ...
        GaussLoader gauss("/home/admin/projects/gt4_app/third_party/gauss_sdk/lib/libpq.so");

        // 使用高斯专用的驱动进行连接
        PGconn* conn = gauss.PQconnectdb("host=10.81.57.151 port=5432 dbname=gfhgot user=hfwot password=fhq6OPx92T");
