 ...
 *
 * This module is essentially the same as the backend's GsString data type,
 * but it is intended for use in frontend libpq and client applications.
 * Thus, it does not rely on mmgr_alloc() nor elog().
 *
...
/*------------------------
 * copyPQExpBufferData
 * Returns a deep copy'PQExpBufferData'
 * Should be freed with termPQExpBuffer().
 */
extern PQExpBufferData copyPQExpBufferData(const PQExpBuffer str);
