/*
 * xa.h header
 * Includes the interfaces defined in the XA Specification.
 *
 * Portions Copyright (c) 2025 Huawei Technologies Co.,Ltd.
 *
 * This header is NOT original. It's a derivative work of this public documentation
...
/* get a raw PGConn from an opened xa connection according to rmid */
PGconn *get_xapg_conn(int rmid);
extern struct xa_switch_t xagsw;
/*
