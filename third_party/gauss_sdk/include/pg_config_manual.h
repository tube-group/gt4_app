...
#define BUCKETMAPLEN 1024
#define BUCKETBITMAPLEN MAX_BUCKET_LEN / 8
...
#define FUNC_MAX_ARGS_INROW 664
...
#define O_LARGE_SEQ_MAXVALUE ((int128)100000000000000*(int128)100000000000000 - (int128)1)
#define O_LARGE_SEQ_MINVALUE ((int128)-10000000000000*(int128)100000000000000 + (int128)1)
...
#define UNIQUE_SQL_ID_ARRAY_SIZE_FOR_PLAN_TRACE 4
#else
#define UNIQUE_SQL_ID_ARRAY_SIZE_FOR_PLAN_TRACE 128
#endif
...
/*
 * Define this to cause mmgr_free()'d memory to be cleared immediately, to
...
/*
 * Define this to resource manager info.
 * MEMORY_CONTEXT_CHECKING macro is a debug macro uniformly used by memcontext. It only takes effect in the debug
 * version. MEMORY_CONTEXT_TRACK takes effect in both debug and release versions.
 * In release version, if ENABLE_LITE_MODE macro or __USE_NUMA macro open, MEMORY_CONTEXT_TRACK will be closed.
 */
...
#ifndef ENABLE_LITE_MODE
#define GUC_RESOURCE_MANAGER
#endif
#endif

#ifndef ENABLE_LITE_MODE
#define ENABLE_RESOURCE_MANAGER
#endif
/*
 * Define this to cause mmgr_alloc()'d memory to be filled with random data, to
 ...
 * node_copy_object(), to facilitate catching errors and omissions in
 * node_copy_object().
